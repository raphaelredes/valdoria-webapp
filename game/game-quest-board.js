...
h+='<div class="v-popup-divider"></div>';h+='<div class="qb-detail-rewards">';h+='<div class="v-popup-section-label">\ud83d\udc8e Recompensas</div>';var rew='';if(q.gold)rew+='<span class="qb-detail-rew-gold"><span class="vi vi-coin sm"></span> '+q.gold+' Valdoritas</span>';if(q.xp)rew+='<span>\u2728 '+q.xp+' XP</span>';h+='<div class="qb-detail-rew">'+rew+'</div>';h+='</div>';if(q.inv==='success'||q.inv==='crit_success'){if(q.hint){h+='<div class="qb-check-result qb-check-success">';h+='\ud83d\udd0d '+vEsc(q.hint)+'</div>';}}else if(q.inv==='fail'){h+='<div class="qb-check-result qb-check-fail">';h+=_T.invFail+'</div>';}
