...
function renderDailyReward(screen) {
    ...
    var bodyHtml = '<div class="daily-popup">' + streakText + '<div class="daily-cycle">' + dayDots + '</div>' + '<div class="daily-gold">\uD83D\uDCB0 ' + r.gold + ' Valdoritas</div>' + itemsHtml + multiplierHtml + recordHtml + '</div>';
    if (window.vPopup) {
