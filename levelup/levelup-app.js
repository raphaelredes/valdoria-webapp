...
(function _initImmersive(){var KEY='valdoria_immersive';var collapsed=false;try{collapsed=localStorage.getItem(KEY)==='1';}catch(e){}
...
toggle.onclick=function(){collapsed=true;try{localStorage.setItem(KEY,'1');}catch(e){}apply();if(typeof haptic==='function')haptic('light');};
restore.onclick=function(){collapsed=false;try{localStorage.setItem(KEY,'0');}catch(e){}apply();if(typeof haptic==='function')haptic('light');};
apply();
