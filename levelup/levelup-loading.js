/* LevelUp loading controller (extracted for SPA) */
    (function() {
        var TIPS = [
        ...
        var tipEl = document.getElementById('init-loading-tip');
        var progressEl = document.getElementById('init-loading-progress');
        var overlay = document.getElementById('initLoading');
        ...
        window._lvlInitLoading = {
            hide: function() {
                ...
                if (remaining > 0) {
                    setTimeout(function() { window._lvlInitLoading.hide(); }, remaining);
                    return;
                }
