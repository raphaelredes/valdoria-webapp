...
(function(){
  ...
  var CART_BIOMES = [
    ...
    { key: 'elven_ruins',     name: 'Ruínas Élficas',    x: 0.72, y: 0.16, biome: 'forest',   tier: 4, ico: '🏛️',
      mapKey: 'Mapa da Floresta',
      desc: 'Restos de uma antiga civilização élfica. A magia ainda pulsa.' },
    // ─── CAVE / UNDERGROUND (Oeste) ──────────────
    { key: 'cave',      name: 'Passagem Subterrânea',    x: 0.22, y: 0.56, biome: 'cave',     tier: 3, ico: '🕳️',
    ...
    // ─── MOUNTAIN (Noroeste) ──────────────────────
    { key: 'mountain',  name: 'Picos de Pedra',           x: 0.2, y: 0.16, biome: 'mountain', tier: 4, ico: '🏔️',
      mapKey: 'Mapa das Montanhas',
    ...
    { key: 'korthag',   name: 'Korthag (Vila Mineira)',   x: 0.07, y: 0.07, biome: 'mountain', tier: 3, ico: '⛏️', settlement: true, discoverable: true,
      mapKey: null,
    ...
    // ─── GRAVEYARD (Sul) ──────────────────────────
    { key: 'graveyard', name: 'Cemitério Antigo',         x: 0.34, y: 0.9, biome: 'graveyard', tier: 3, ico: '⚰️',
      mapKey: 'Mapa do Pântano',
    ...
    // ─── SNOW (Norte distante) ────────────────────
    { key: 'snow',      name: 'Ermo Congelado',           x: 0.5, y: 0.05, biome: 'snow',     tier: 5, ico: '❄️',
