...
window.ValdoriaLoadingHTML = function(opts) {
    ...
    if (icon === 'backpack') {
        ...
        iconHTML = '<div class="loading-particles">' + particles + '</div>'
          ...
          + '</svg>'
          // Gem — 3D animated orb (Orb of Valdoria)
          + '<div class="mc-gem" id="mc-gem"><div class="mc-gem-flare"></div>'
          + '<div class="mc-orb">'
          + '<div class="mc-orb-nebula">'
          + '<div class="mc-orb-neb1"></div><div class="mc-orb-neb2"></div>'
          + '<div class="mc-orb-neb3"></div><div class="mc-orb-neb4"></div>'
          + '<div class="mc-orb-wisp mc-orb-w1"></div>'
          + '<div class="mc-orb-wisp mc-orb-w2"></div>'
          + '<div class="mc-orb-wisp mc-orb-w3"></div>'
          + '<div class="mc-orb-spark mc-orb-sp1"></div>'
          + '<div class="mc-orb-spark mc-orb-sp2"></div>'
          + '</div>'
          + '<div class="mc-orb-core"></div><div class="mc-orb-core-fl"></div>'
          + '<div class="mc-orb-term"></div><div class="mc-orb-fresnel"></div>'
          + '<div class="mc-orb-gp"></div><div class="mc-orb-grim"></div><div class="mc-orb-spec"></div>'
          + '</div></div>'
          // Pulses
