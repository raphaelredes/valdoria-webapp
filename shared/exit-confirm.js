...
function _resolveHeartbeatCfg(){var api='',tk='',uid=0;if(window.S){api=S.apiBase||S.api||'';tk=S.token||'';uid=parseInt(S.uid, 10)||0;}
if(!api&&typeof apiBase!=='undefined')api=apiBase;if(!tk&&typeof token!=='undefined')tk=token;if(!uid&&typeof userId!=='undefined')uid=parseInt(userId, 10)||0;if(api&&tk&&uid)return{apiBase:api,token:tk,uid:uid};return null;}
