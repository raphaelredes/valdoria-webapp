...
function _renderQuestBoard() {
    ...
    if (!quests.length) {
        boardEl.innerHTML = '<div class="guild-empty"><span class="guild-empty-icon">&#x1F4CB;</span>O quadro de missões está vazio.<br>Volte mais tarde para novas oportunidades.</div>';
        return;
    }
