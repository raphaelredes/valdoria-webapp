...
function _drawWalkingFigure(ctx, cx, groundY, frame, elapsed) {
    const s = 2.0;
    // Proportions matched to real walking reference
    const headR = 5.5 * s;
    const neckH = 2 * s;
    const torsoH = 28 * s;          // shorter, wider torso like reference
    const thighL = 24 * s;
    const shinL = 22 * s;
    const footH = 3.5 * s;
    const armLen = 20 * s;
    ...
    // Volume shading (far side darker)
