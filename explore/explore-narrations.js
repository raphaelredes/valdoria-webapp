...
const POI_NARRATIONS = {
    discovery: {
        forest: [
            ...
            "Marcas de garras profundas em um tronco indicam o territorio de algo grande.",
            ...
            "Raizes entrelaçadas formam uma escada natural descendo para a escuridao.",
        ],
        plains: [
            ...
            "Uma torre de pedra solitaria ergue-se no campo, sem porta ou janela visivel.",
            "Flores de fogo alaranjadas balançam ao vento, liberando polen cintilante.",
            "Um circulo de terra escura marca onde uma fogueira ardeu por seculos.",
            "Trilhas de animais convergem para um ponto — algo os atrai ali.",
            "Uma arvore solitaria no meio do campo tem raizes expostas como tentaculos.",
        ],
        swamp: [
            ...
            "Vaga-lumes formam espirais hipnoticas sobre as aguas escuras e paradas.",
            "Uma arvore petrificada ergue-se como um monumento em meio a lama.",
            "Nenufares gigantes flutuam como plataformas sobre a agua turva.",
            "O ar fica denso e doce ao redor de flores carnivoras que se movem.",
            "Uma ponte de troncos caidos conecta ilhotas de terra seca no pantano.",
        ],
        cave: [
            ...
            "Uma cachoeira subterranea cria um arco-iris permanente na escuridao.",
            "Formaçoes de sal cristalizado brilham como diamantes nas paredes.",
            "Um lago subterraneo reflete o teto como um espelho perfeito e imovel.",
            "Colunas naturais de estalagmites e estalactites formam um salao de pedra.",
            "Correntes de ar trazem cheiros de superficie — uma saida proxima talvez.",
        ],
        desert: [
            ...
            "Uma flor do deserto abre suas petalas apenas sob a luz da lua cheia.",
            "Pegadas fossilizadas na rocha contam historias de criaturas extintas.",
            "Uma formaçao rochosa cria sombra permanente — oasis de frescor no calor.",
        ...
        mountain: [
            ...
            "Cabras montesas observam do alto — guardias silenciosas da trilha.",
            ...
            "Cristais de ametista brotam de uma fenda na encosta ingreme.",
        ],
        snow: [
            ...
            "Gelo esculpido pelo vento forma figuras que parecem dançarinas imoveis.",
            "Um pinheiro coberto de neve tem formato perfeito como um sino gigante.",
            "Pegadas de urso no gelo indicam que voce nao esta sozinho aqui.",
            "Cristais de neve gigantes cobrem o chao como joias espalhadas.",
        ],
        volcanic: [
            ...
            "Rochas vulcanicas formam torres naturais como sentinelas petrificadas.",
            "Um rio de lava solidificada cria uma trilha negra e brilhante.",
            "Geiseres menores borbulham ritmicamente como a respiraçao da montanha.",
        ],
        graveyard: [
            ...
            "Uma arvore morta tem galhos que parecem braços suplicando ao ceu.",
            "Nevoa rasteira cobre o chao, ocultando lapides e raizes expostas.",
            "Um mausoleu de marmore branco destoa da escuridao ao redor.",
            "Velas flamejam sem cera em um altar esquecido entre as tumbas.",
            "Corvos observam em silencio absoluto — juizes imoveis da morte.",
        ],
    },
    search: {
        forest: [
            ...
            "Cascas de arvore empilhadas indicam acampamento recente.",
            "Um buraco de animal tem brilho metalico em seu interior escuro.",
        ],
        plains: [
            ...
            "Uma depressao circular no campo parece artificial.",
        ],
        swamp: [
        ...
        cave: [
            ...
            "Marcas de picareta na parede indicam mineraçao abandonada.",
        ...
        desert: [
            ...
            "Um monticulo de areia tem forma geometrica — algo enterrado.",
            "Fragmentos de vidro vulcanico indicam comercio antigo nesta rota.",
        ],
        mountain: [
            ...
            "Musgo arrancado revela simbolos entalhados na rocha.",
        ],
        snow: [
        ...
        volcanic: [
            ...
            "Cinzas acumuladas formam um monte sobre algo rigido embaixo.",
        ...
        graveyard: [
            ...
            "Velas derretidas formam um caminho ate uma cripta aberta.",
            "Raizes levantaram uma laje, revelando um compartimento abaixo.",
        ],
    },
    mystery: {
        forest: [
            ...
            "Uma clareira pulsa com energia verde — arvores se curvam em reverencia.",
        ],
        plains: [
            ...
            "O chao vibra em ondas concentricas a partir de uma pedra rachada.",
        ...
        swamp: [
            ...
            "A agua do pantano gira em redemoinho ao redor de uma luz submersa.",
            "Sapos coaxam em unissono formando uma melodia hipnotica antiga.",
        ],
        cave: [
            ...
            "Cristais pulsam em sequencia como um coraçao de pedra batendo.",
            "A escuridao nao e uniforme — manchas de sombra se movem com proposito.",
        ],
        desert: [
            ...
            "Graos de areia flutuam formando simbolos no ar quente e parado.",
            "O horizonte se distorce num ponto especifico como uma lente viva.",
        ],
        mountain: [
            ...
            "Pedras flutuam acima do solo ao redor de um ponto magnetico.",
            "O eco retorna suas palavras numa lingua diferente da que voce falou.",
        ],
        snow: [
            ...
            "A neve derrete em circulo perfeito apesar do frio intenso ao redor.",
            "Flocos de neve sobem ao inves de cair num raio de poucos metros.",
        ],
        volcanic: [
            ...
            "Chamas brotam da rocha em cores impossiveis — azul, verde, prata.",
            "A lava endurece e racha formando runas que brilham com luz propria.",
        ],
        graveyard: [
            ...
            "Uma brisa gelada sopra de dentro da terra — direçao impossivel.",
        ],
    },
    danger: {
        forest: [
            ...
            "O silencio absoluto da floresta e o pior sinal — passaros fugiram.",
            "Pegadas frescas na lama umida levam diretamente na sua direçao.",
        ],
        plains: [
            ...
            "Uma nuvem de poeira se ergue no horizonte — algo corre na sua direçao.",
        ...
        swamp: [
            ...
            "A nevoa se adensa e formas escuras se movem em sua periferia.",
            "O cheiro de sangue paira no ar umido — algo caçou aqui.",
        ],
        cave: [
            ...
            "Sua tocha vacila e projeta sombras que nao correspondem a nada.",
            "Um cheiro acido queima seu nariz — algo venenoso esta proximo.",
        ],
        desert: [
