...
const TUTORIAL_STEPS = [
    { target: '#iso-map', title: 'Mapa de Explora\u00e7\u00e3o', text: 'Este \u00e9 o mapa hexagonal. Toque nos hex\u00e1gonos adjacentes ao seu personagem para se mover.', position: 'center', icon: '\U0001f5fa\ufe0f',
    ...
    { target: '#hud', title: 'Barra de Status', text: 'Aqui voc\u00ea v\u00ea o nome do personagem, vida (HP), XP e ouro acumulados, hora do dia e clima.', position: 'below', icon: '\u2764\ufe0f',
      illust: '<div class="ti-hud"><span class="ti-hud-name">Aldric</span><span class="ti-hud-hp"><span class="ti-hp-label">HP</span><span class="ti-hp-bar"><span class="ti-hp-fill" style="width:75%"></span></span><span class="ti-hp-val">8/10</span></span><span class="ti-badge">XP 120</span><span class="ti-badge">\U0001f4b0 45</span><span class="ti-badge">\U0001f324\ufe0f</span></div>' },
    { target: '#minimap', title: 'Minimapa', text: 'O minimapa mostra uma vis\u00e3o geral da regi\u00e3o. O ponto dourado \u00e9 voc\u00ea, o verde \u00e9 a sa\u00edda.', position: 'below-left', icon: '\U0001f9ed',
      illust: '<div class="ti-minimap"><div class="ti-minimap-box"><span class="ti-mm-dot ti-mm-player"></span><span class="ti-mm-dot ti-mm-exit"></span><span class="ti-mm-dot ti-mm-explored" style="top:30%;left:55%"></span><span class="ti-mm-dot ti-mm-explored" style="top:50%;left:35%"></span></div><span class="ti-minimap-label">Toque para expandir</span></div>' },
    { target: '.btn-return', title: 'Retornar \u00e0 Cidade', text: 'Quando quiser encerrar a explora\u00e7\u00e3o, toque aqui para avaliar os riscos do retorno e voltar \u00e0 cidade.', position: 'above', icon: '\U0001f3e0',
      illust: '<div class="ti-btn-row"><span class="ti-btn-mock ti-btn-return">\U0001f3e0 Retornar</span></div>' },
    { target: '.btn-explore', title: 'Explorar \u00c1rea', text: 'Toque aqui para investigar o hex atual \u2014 procurar itens, forragear ou observar os arredores.', position: 'above', icon: '\U0001f50d',
      illust: '<div class="ti-btn-row"><span class="ti-btn-mock ti-btn-explore">\U0001f50d</span></div>' },
    { target: '.pace-toggle', title: 'Ritmo de Viagem', text: 'Alterne entre R\u00e1pido (2 hexes, \u22125 Percep\u00e7\u00e3o), Normal ou Cauteloso (+5 Percep\u00e7\u00e3o, \u22122 DC). Regra do PHB Cap.8.', position: 'above', icon: '\U0001f6b6',
      illust: '<div class="ti-pace-row"><span class="ti-pace ti-pace-fast">\U0001f6b4 R\u00e1pido</span><span class="ti-pace ti-pace-normal ti-pace-active">\U0001f6b6 Normal</span><span class="ti-pace ti-pace-cautious">\U0001f6e1\ufe0f Cauteloso</span></div>' },
    { target: '.bar-center', title: 'Passos e Perigo', text: 'O n\u00famero mostra hexes visitados. Os pontos vermelhos indicam o n\u00edvel de perigo \u2014 quanto mais cheios, mais perigoso.', position: 'above', icon: '\u26a0\ufe0f',
      illust: '<div class="ti-steps-row"><span class="ti-step-count">12</span><span class="ti-step-label">passos</span><span class="ti-danger-pips"><span class="ti-pip ti-pip-filled"></span><span class="ti-pip ti-pip-filled"></span><span class="ti-pip ti-pip-filled"></span><span class="ti-pip"></span><span class="ti-pip"></span></span></div>' },
    { target: '#map-viewport', title: 'N\u00e9voa de Guerra', text: '\u00c1reas escuras ainda n\u00e3o foram exploradas. Conforme voc\u00ea se move, a n\u00e9voa se dissipa revelando o terreno e pontos de interesse.', position: 'center', icon: '\U0001f32b\ufe0f',
      illust: '<div class="ti-fog-row"><div class="ti-fog-hexes"><div class="ti-fog-hex ti-fog-hidden">?</div><div class="ti-fog-hex ti-fog-partial">\U0001f332</div><div class="ti-fog-hex ti-fog-clear">\U0001f332</div></div><div class="ti-fog-labels"><span>Oculto</span><span>Parcial</span><span>Revelado</span></div></div>' },
    { target: '#map-viewport', title: 'Eventos e Encontros', text: 'Ao explorar, voc\u00ea encontrar\u00e1 eventos narrativos, armadilhas, NPCs e combates. Testes de habilidade D&D 5e determinam o resultado \u2014 com dados 3D!', position: 'center', icon: '\U0001f3b2',
      illust: '<div class="ti-events-row"><span class="ti-event-icon">\U0001f4dc</span><span class="ti-event-icon">\u2694\ufe0f</span><span class="ti-event-icon">\U0001f5e3\ufe0f</span><span class="ti-event-icon">\U0001faa4</span><span class="ti-event-icon">\U0001f3b2</span></div>' },
...
function _buildTutorialDOM() {
    ...
    // Illustration
    const il = document.createElement('div'); il.className = 'tutorial-card-illust'; il.id = 'tutorial-illust';
    card.appendChild(il);
...
function _showTutorialStep(idx) {
    ...
    // Illustration
    var illustEl = document.getElementById('tutorial-illust');
    if (illustEl) {
        if (step.illust) { illustEl.innerHTML = step.illust; illustEl.style.display = ''; }
        else { illustEl.innerHTML = ''; illustEl.style.display = 'none'; }
    }
