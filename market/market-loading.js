/* Market loading controller (extracted for SPA) */
    (function() {
        var TIPS = [
        ...
        var overlay = document.getElementById('marketLoading');
        ...
        window._marketLoadingCtrl = {
            hide: function() {
                ...
                if (remaining > 0) {
                    setTimeout(function() { window._marketLoadingCtrl.hide(); }, remaining);
                    return;
                }
