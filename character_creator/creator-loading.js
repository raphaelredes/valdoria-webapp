/* Character Creator loading controller (extracted for SPA) */
    (function() {
        var TIPS = [
        ...
        var overlay = document.getElementById('creatorLoading');
        ...
        window._creatorLoadingCtrl = {
            hide: function() {
                ...
                if (remaining > 0) {
                    setTimeout(function() { window._creatorLoadingCtrl.hide(); }, remaining);
                    return;
                }
