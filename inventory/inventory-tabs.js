...
function getSortedFilteredItems(){let items=getFilteredItems();if(searchQuery){items=items.filter(inv=>typeof itemMatchesSearch==='function'?itemMatchesSearch(inv,searchQuery):inv.n.toLowerCase().includes(searchQuery));}
