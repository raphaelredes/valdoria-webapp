...
function cycleSort(){const idx=SORT_CYCLE.indexOf(sortMode);sortMode=SORT_CYCLE[(idx+1)%SORT_CYCLE.length];localStorage.setItem('valdoria_inv_sort',sortMode);haptic('light');renderTab();}
function setFilter(f){activeFilter=f;localStorage.setItem('valdoria_inv_filter',activeFilter);renderTab();}
