...
(()=>{vHaptic.select();if(!_audioUnlocked){if(_audioCtx&&_audioCtx.state==='suspended'){_audioCtx.resume().then(()=>{_audioUnlocked=true;}).catch(()=>{});}else if(_audioCtx&&_audioCtx.state==='running'){_audioUnlocked=true;}}
