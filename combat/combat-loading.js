/* Combat loading controller (extracted for SPA) */
    (function() {
        var TIPS = [
        ...
        var overlay = document.getElementById('combatLoading');
        ...
        window._combatLoadingCtrl = {
            hide: function() {
                ...
                if (remaining > 0) {
                    setTimeout(function() { window._combatLoadingCtrl.hide(); }, remaining);
                    return;
                }
