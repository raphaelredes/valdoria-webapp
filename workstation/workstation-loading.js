/* Workstation loading controller (extracted for SPA) */
    (function() {
        var TIPS = [
        ...
        var overlay = document.getElementById('wsLoading');
        ...
        window._wsLoadingCtrl = {
            hide: function() {
                ...
                if (remaining > 0) {
                    setTimeout(function() { window._wsLoadingCtrl.hide(); }, remaining);
                    return;
                }
